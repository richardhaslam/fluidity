...
\item Particle and Detector files - files related to checkpointing of
  particles and detectors are created.
\end{enumerate}

ANGUS - Fixme - write a little about checkpointing for particles and (static) detectors please. I've commented out the old text, but it's below for your reference.
...
CHRIS - Fix me... write a little here about the various options under particle tree. 

If particles are selected, the user must specify \option{/particle\_group}, which is... and a \option{/particle\_subgroup}. Groups and subgroups are distinguished by... Under each subgroup, the number of particles must be specified, in addition to their initial position... Any attributes that the user wants to calculate and/or track on particles should be set under... 
...
ANGUS - Fix me... write a little here about particle and detector file format please...'

The output of the detectors and particles is...
